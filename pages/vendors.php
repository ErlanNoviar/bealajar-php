          ...
          <div class="row">
            ...
            <div class="col-lg-2 col-3">
              ...
              <div class="">
                ...
                <a href="form-tambah-vendors.php" class="btn btn-block btn-primary">Tambah Data  <i class="nav-icon fas fa-plus mr-2"></i></a>
                <br>
              </div>
            </div>
            <!-- akhir tambah data -->
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <table id="example2" class="table table-bordered table-striped">
                    ...
                    <?php
                       ...
                       $categories = array(
                        ...
                        $sql = "SELECT id, code, name, phone_number, email, address, created_at, is_active
                        FROM vendors
                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo '<td>
                                        <a href="form-edit-vendors.php?id=' . $row["id"] . '" class="btn btn-warning">Edit</a>
                                        <a href="proses-delete-vendors.php?id=' . $row["id"] . '" class="btn btn-danger">Hapus</a>
                                     </td>';
                                echo "</tr>";
                                $i++;
                            }
                  ...
                  <?php
                    ...
                    if ($page > 1) {
                        echo "<li class='page-item'><a class='page-link' href='vendors.php?page=" . ($page - 1) . "'>Previous</a></li>";
                    }
                    ...
                    for ($i = max(1, $page - 2); $i <= min($page + 2, $total_pages); $i++) {
                        ...
                        echo "'><a class='page-link' href='vendors.php?page=" . $i . "'>" . $i . "</a></li>";
                    }

                    if ($page < $total_pages) {
                        echo "<li class='page-item'><a class='page-link' href='vendors.php?page=" . ($page + 1) . "'>Next</a></li>";
                    }
                    echo "</ul>";
                    ?>
                </div>
